...
ROOMS = {
    ...
    "memory_room": { #моя комната - комната воспоминаний
        ...
        "items": ["amethyst"],
        "puzzle": ('Голос из темноты: "Сегодня понедельник, что было вчера?" '
        '(ответ одно слово)', "воскресенье"),
    },
    "dreamy_room": { #моя комната - комната мечт
        ...
        "items": ["pea"],
        "puzzle": (
            'На стене возле кровати расположился сюжет из сказки '
            'Ганса Христиана Андерсена, '
            'а внизу подпись, название, но последнее слово стерто: '
            '"Принцесса на ?"(ответ одно слово '
